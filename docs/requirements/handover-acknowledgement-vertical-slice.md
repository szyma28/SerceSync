...
The next logical extension is task accountability during the shift:

1. list current shift tasks
2. mark a task complete
3. defer or escalate a task with reason capture
4. surface the resulting exception state for manager review
